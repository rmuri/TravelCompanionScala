...
object Gauge {
  ...
  def renderOnLoad(value: Int) = {
    val resources = "	var objImg = new Image();var objImg2 = new Image();		objImg2.src = '/"+ LiftRules.resourceServerPath +"/gauge/arrow.png';objImg.src = '/"+ LiftRules.resourceServerPath +"/gauge/gauge.png';"
